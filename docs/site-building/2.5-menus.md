...
## Questions
<Question title="What are the default menus provided by the core Standard installation profile in Drupal?">

The core Standard installation includes five default menus:
1. Main navigation (for site visitors)
2. Administration (for admin tasks)
3. User account menu (for user-specific actions)
4. Footer (for important footer links)
5. Tools (for visitor tasks)
</Question>

<Question title="How can you add or edit menus and menu items in Drupal?">
...
<Question title="How are menus placed on a Drupal site, and what is the relationship between menus and blocks?">
