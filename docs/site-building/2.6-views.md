...
## Questions
<Question title="What are Views in Drupal, and what functionalities do they offer?">
...
<Question title="How can you add a new view, access existing list of all views and enable? and what are `displays` in Drupal Views?">
...
<Question title="What are some of the format options available for displaying views, and how can you add fields to a view display?">
...
<Question title="What is the function of exposed filters, pager and Contextual Filters?">
