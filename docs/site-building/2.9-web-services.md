...
## Questions
<Question title="What is the purpose of Drupal's RESTful Web Services API?">
...
<Question title="Which core modules in Drupal provide web services functionality?">
...
<Question title="What are the safe HTTP methods and unsafe HTTP methods supported by Drupal's RESTful Web Services, and what are their purposes?">
...
<Question title="What authentication methods are available for Drupal's RESTful Web Services?">
...
<Question title="How can REST resources be configured in Drupal, and what are the two methods?">
