...
## Questions
<details>
  <summary>What is a taxonomy in Drupal, and how are vocabularies and terms structured within it?</summary>
...
<details>
  <summary>How can you add a new vocabulary or terms to an existing vocabulary in Drupal?</summary>
...
<details>
  <summary>What is free tagging in Drupal, and how can it be enabled for taxonomy term references?</summary>
