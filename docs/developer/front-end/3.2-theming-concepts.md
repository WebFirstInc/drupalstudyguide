...
```[Question 1]
On the /admin/appearance page, what action can you take to 
set a theme as the active theme for your Drupal site?

1. Click on "Activate" next to the theme
2. Click on "Enable" next to the theme
3. Click on "Set as Default" next to the theme
```

```[Answer]
3. Click on "Set as Default" next to the theme

You must also install the theme first, but the "Set as Default" action will 
...
```[Question 2]
Which of the following options can you find on the /admin/appearance page?

1. A list of theme libraries
2. A list of available themes
3. A style guide
```
...
The page will allow you to choose from a list of available themes and configure them.
```
