...
Strings are added to this list by Drupal's StringTranslation service. This service is called by the [`t()` function](https://api.drupal.org/api/drupal/core%21includes%21bootstrap.inc/function/t/8), the translate service `\Drupal::translate()`, and the twig filter `{{ 'My string' | t }}`.
