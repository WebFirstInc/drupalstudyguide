...
## Questions
<details>
  <summary>What are display modes in Drupal, and how do view modes and form modes differ in their functionality?</summary>

Display modes define how content entities are presented for viewing or editing. View modes customize how content is displayed, while form modes define how fields are ordered and customized for editing.
</details>

<details>
  <summary>How can you view and manage the available view modes for a specific content type in Drupal?</summary>

To manage view modes, go to `Structure > Display modes > View modes`. To customize them for a content type, navigate to `Structure > Content types > Edit > Manage display > Custom Display Settings`.
</details>
