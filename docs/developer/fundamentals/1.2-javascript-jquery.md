...
<details>
  <summary>What change was made to jQuery in Drupal 8 compared to Drupal 7?</summary>
...
<details>
  <summary>How do you include local JavaScript libraries in a Drupal theme? Provide an example.</summary>
...
<details>
  <summary>What are the advantages of using Drupal.behaviors over $(document).ready() in Drupal?</summary>
