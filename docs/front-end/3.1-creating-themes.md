...
<Question title="What is the default theme for Drupal 10?">
...
<Question title="What is the purpose of the Starterkit?">
...
<Question title="When creating a theme.info.yml file, which keys are always required?">
...
<Question title="Which file is used to define CSS and JS in a theme?">
