...
<summary>What keyword can be used to disable access to all variables except for specified ones when including a template in Twig?</summary>

**Answer:** The keyword is `only`.
...
<summary>What is the purpose of the `extends` tag in a Twig template?</summary>

**Answer:** The 'extends' tag is used to override a block in a parent template.
...
<summary>What happens if a child template does not define a block that exists in the parent template?</summary>

**Answer:** The parent template's block value is used.
