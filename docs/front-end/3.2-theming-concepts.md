...
## Questions
<Question title="What is the purpose of the /admin/appearance page?">

**Answer**: The page will allow you to choose from a list of available themes and configure them.
</Question>

<Question title="On the /admin/appearance page, what action can you take to set a theme as the active theme for your Drupal site?">

**Answer**: Click the "Set as Default" button next to the theme.
You must also install the theme first, but the "Set as Default" action will activate the installed theme.
</Question>
