...
## Questions
<Question title="What syntax does Twig use to output data in templates?">

**Answer**: Twig uses the <code>&lcub;&lcub; &rcub;&rcub;</code> syntax to output data in templates.
</Question>

<Question title="What syntax is used to access arrays and objects in twig?">
...
<Question title="What is the purpose of the {% trans %} tag in Twig?">
