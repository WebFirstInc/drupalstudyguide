...
## Questions
<details>
  <summary>How do you define a plugin using annotations, and what are the key components of an annotations-based plugin?</summary>
...
<details>
  <summary>What are the five plugin discovery methods, and how do they differ in how plugins are registered and discovered?</summary>
...
<details>
  <summary>Which quotes should we use when defining a plugin?</summary>
