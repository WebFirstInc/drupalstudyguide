...
## Questions
<Question title="How do you define a plugin using annotations, and what are the key components of an annotations-based plugin?">
...
<Question title="What are the five plugin discovery methods, and how do they differ in how plugins are registered and discovered?">
...
<Question title="Which quotes should we use when defining a plugin?">
