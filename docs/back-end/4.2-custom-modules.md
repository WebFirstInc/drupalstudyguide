...
`type (required)` - indicates the type of extension, i.e., "module", "theme", or "profile"

`description (optional)` - displayed on the "Extend" page
...
`version (optional)` version of your module
