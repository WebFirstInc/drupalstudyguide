...
<Question title="What are examples of Drupal Entities?">
Nodes, Users, Blocks, and Menus are all entities, and fundamental parts of Drupal.
</Question>

<Question title="What is the difference between an Entity Type ID and a Bundle? Give an example.">
Entity Type ID is the base type of the entity, ie Node or Block. A bundle is a
subcategory of entity type with its own configurable fields and settings. Not
all entity types have bundles.
...
<Question title="What Drupal service might you use to retrieve entities by type or property value?">
