...
<details>
<summary>
You have defined a custom route with the URL "/test-url/test". What will happen if User tries to access "/test-url///test"?
</summary>
...
<details>
<summary>
You need to have a new URL like "/node/{node}/test". How can you pass the entire node object to the controller?
</summary>
