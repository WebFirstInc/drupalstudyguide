...
<details>
<summary>
How can you create a custom cache bin in Drupal using a services.yml file?
</summary>
...
<details>
<summary>
What is the difference between cache deletion and invalidation in Drupal, and when should each be used?
</summary>
...
<details>
<summary>
You have a render array which is changing depending on which page it is displayed. This render array includes data retrieved from the current user. Which cache configurations should be applied?
</summary>
