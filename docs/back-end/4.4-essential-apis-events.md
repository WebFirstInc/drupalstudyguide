...
## Questions
<details>
    <summary>What two things do you need to subscribe to events?</summary>

1. Create a class which implements <code>Symfony\Component\EventDispatcher\EventSubscriberInterface</code>
1. Define a service in your module for the class you created, and give it the `event_subscriber` tag
</details>

<details>
    <summary>How can you dispatch an event with Drupal's default class?</summary>
