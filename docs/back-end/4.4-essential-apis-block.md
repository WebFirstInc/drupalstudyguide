...
### General
<details>
  <summary>What are the different APIs that make up what is commonly referred to as the Block API and what are their purpose?</summary>
...
<details>
  <summary>What are the 3 steps of creating a custom block?</summary>
...
<details>
  <summary>Which method must be implemented when creating a custom block plugin?</summary>

`build()`
</details>

<details>
  <summary>When creating a custom block plugin, how do you define its administrative label?</summary>
Using an annotation in the block plugin class
</details>

<details>
  <summary>If a block needs to display dynamic content based on the current node being viewed, which caching mechanism should you use?</summary>
