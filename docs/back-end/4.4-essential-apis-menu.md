...
## Questions
<details>
  <summary>What is the role of hook_menu_links_discovered_alter() in defining or altering menu links?</summary>
...
<details>
  <summary>How can you add an Add menu or Add link action to the admin panel using the Menu API?</summary>
...
<details>
  <summary>How do hook_contextual_links_view_alter() and hook_contextual_links_alter() assist in managing contextual links dynamically?</summary>
