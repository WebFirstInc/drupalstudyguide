...
<details>
  <summary>What is the purpose of using the "git rebase" command in Git, and how does it differ from git merge in terms of handling the commit history of a branch?</summary>
...
<details>
  <summary>What does the --amend flag do when used with the git commit command, and in what scenarios might it be useful?</summary>
...
<details>
  <summary>How does the "git bisect" command help in debugging, and what are the basic steps to use it to identify a problematic commit?</summary>
